  ...
  return (
    <section className="management-container">
      ...
      <main
        className={
          responsive
            ? "management-menu-container management-menu-container-reponsive"
            : "management-menu-container"
        }
      >
        <div
          title="products-secction"
          className="management-menu-section"
        ...
        <div
          title="oferts-section"
          className="management-menu-section"
          onClick={() => navigate("/management/oferts")}
        >
          <h4>Ofertas</h4>
          <div className="icon-management-section">
            <img src={OfertsManagement.src} alt="oferts" width="55px" />
        ...
        <div title="contac-section" className="management-menu-section">
          <h4>Contacto</h4>
          <div
            className="icon-management-section"
            onClick={() => navigate("/management/contact")}
          >
